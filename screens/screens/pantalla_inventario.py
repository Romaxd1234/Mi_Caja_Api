...
class VentanaInventario(Screen):
    ...
    def __init__(self, **kwargs):
        ...
        self.layout_superior = BoxLayout(size_hint_y=None, height=dp(50), spacing=dp(10))
        self.input_producto = TextInput(hint_text='Producto', multiline=False, font_size=dp(16))
        self.input_precio = TextInput(hint_text='Precio', multiline=False, input_filter='float', font_size=dp(16))
        self.input_piezas = TextInput(hint_text='Piezas', multiline=False, input_filter='int', font_size=dp(16))
        self.boton_agregar = Button(text='Agregar', size_hint_x=None, width=dp(100))
        ...
        self.grid_productos = GridLayout(cols=1, spacing=dp(10), size_hint_y=None)
        ...
        layout_inferior = BoxLayout(size_hint_y=None, height=dp(120), padding=dp(10), spacing=dp(20))

        col_izquierda = BoxLayout(orientation='vertical', spacing=dp(10))
        self.boton_editar = Button(text='Editar', size_hint_y=None, height=dp(50), disabled=True)
        self.boton_editar.bind(on_release=self.editar_producto)
        self.boton_volver = Button(text='Volver', size_hint_y=None, height=dp(50))
        ...
        col_derecha = BoxLayout(orientation='vertical', spacing=dp(10))
        self.boton_eliminar = Button(text='Eliminar', size_hint_y=None, height=dp(50), disabled=True)
        self.boton_eliminar.bind(on_release=self.eliminar_producto)
        self.boton_ir_a_ventas = Button(text='Ir a Ventas', size_hint_y=None, height=dp(50))
        ...
        widget_espacio = Widget(size_hint_x=None, width=dp(20))
        layout_inferior.add_widget(col_izquierda)
        layout_inferior.add_widget(widget_espacio)
        layout_inferior.add_widget(col_derecha)
        self.layout_principal.add_widget(Widget(size_hint_y=None, height=dp(20)))
